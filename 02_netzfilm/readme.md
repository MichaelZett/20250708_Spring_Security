...
# Security - Basic
- security ist per default an sobald die dependencies auf dem classpath liegen
- im log nach "Using generated security password" suchen für das Passwort (User: user)
- wir übersteuern das dann hier mit unserer eigenen SecurityConfig
- da Security jetzt an ist, müssen wir das auch in unseren Tests nachziehen
