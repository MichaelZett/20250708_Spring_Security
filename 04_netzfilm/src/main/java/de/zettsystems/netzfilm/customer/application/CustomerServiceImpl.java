...
public class CustomerServiceImpl implements CustomerService {
    ...
    @Override
    public void addCustomer(CustomerDataTo customer) {
        String newPwd = PasswordGenerator.generate(16);
        LOG.info("Neues Passwort {} für User {}", newPwd, customer.username());
        customerRepository.save(new Customer(customer.username(), argon2PasswordEncoder.encode(newPwd), customer.name(), customer.lastName(), customer.birthdate(),
