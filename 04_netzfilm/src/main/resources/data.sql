...
values (nextval('USER_SEQ'), 0, '68111897-39bd-4db6-9c6a-f7080690fb2a', 'petra', 'STAFF',
        'Meyer', 'Petra', '$argon2id$v=19$m=16384,t=2,p=1$2DhnHlcnb2z1deZdalPPDQ$OBKas0ScGRNNfnvv36838vdWUQyZipSXZPtKPaimngs', '1963-07-11');
insert into users (ID, VERSION, UUID, USERNAME, USER_TYPE, LAST_NAME, NAME, PASSWORD, BIRTHDATE)
values (nextval('USER_SEQ'), 0, '97eb8fc7-3a5f-4774-bdc7-aeeef0964ff9', 'frank', 'STAFF',
        'Schuhmacher', 'Frank', '$argon2id$v=19$m=16384,t=2,p=1$XEYndbC9t5XvXlCXaFSMEQ$Ec0MZMvenzIhXV14/bdL42F+b3u4wFh0i4vZdWgGCCs','1981-02-28');
insert into users (ID, VERSION, UUID, USERNAME, USER_TYPE, LAST_NAME, NAME, PASSWORD, BIRTHDATE)
values (nextval('USER_SEQ'), 0, '77c4f5dd-b29c-4976-9c30-47cc00f0f7d2', 'anke', 'CUST',
        'Müller', 'Anke', '$argon2id$v=19$m=16384,t=2,p=1$d9k6WhY1pc4KpjVKaHDjew$NNU3Ih1rKGNeqHDlgeZEO5KNgx7mvn8qe5dkjqsOXJk', '1975-09-03');
insert into users (ID, VERSION, UUID, USERNAME, USER_TYPE, LAST_NAME, NAME, PASSWORD, BIRTHDATE)
